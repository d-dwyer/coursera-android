...
public class FriendsFragment extends ListFragment {
	...
	private static final String SELECTED_FRIEND_KEY = "friend";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState != null){
			selectedFriend = savedInstanceState.getInt(SELECTED_FRIEND_KEY);
			mCallback.onItemSelected(selectedFriend);
		}
	}
	...
	public void onSaveInstanceState(Bundle savedInstanceState) {
		...
		savedInstanceState.putInt(SELECTED_FRIEND_KEY, selectedFriend);
